...
{{--            </div>--}}
{{--        </a>--}}
{{--        <a href="{{ cp_route('collections.show', ['blogs']) }}" class="w-full lg:w-1/2 p-2 flex items-start hover:bg-grey-20 rounded-md group">--}}
{{--            <div class="h-8 w-8 mr-2 text-grey-80">--}}
...
{{--            </div>--}}
{{--        </a>--}}
{{--        <a href="{{ cp_route('globals.variables.edit', ['client']) }}" class="w-full lg:w-1/2 p-2 flex items-start hover:bg-grey-20 rounded-md group">--}}
{{--            <div class="h-8 w-8 mr-2 text-grey-80">--}}
{{--                @cp_svg('flag')--}}
{{--            </div>--}}
{{--            <div class="flex-1">--}}
